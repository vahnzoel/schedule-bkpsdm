...
!(function (e, t) {
    ...
    function r(e) {
        ...
        l.setOptions(n, !0), l.changeView(a, !0), k(), p(), w();
    }
    function d(e) {
        switch (f(e.target)) {
            case "move-prev":
    ...
    function u(e) {
        var t,
            n = f($(e.target).closest('a[role="menuitem"]')[0]);
        (t = n),
            (e = document.getElementById("calendarName")),
            (n = findCalendar(t)),
            (t = []).push(
            ...
            t.push('<span class="calendar-name">' + n.name + "</span>"),
            (e.innerHTML = t.join("")),
            (i = n);
    }
    function g(e) {
        ...
        a && l.openCreationPopup({ start: t, end: e });
    }
    function m(e) {
