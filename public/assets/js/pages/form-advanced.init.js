        ...
        n
                ...
                switch (e) {
                    ...
                    case "language":
                        $('input[name="format"]').val(
                            $.fn.datepicker.languages[s].format
                        );
                }
                (c[e] = s),
                    n.datepicker("reset").datepicker("destroy").datepicker(c);
            }),
            $(".docs-actions").on("click", "button", function (e) {
                ...
                e.stopPropagation(),
                    t.method &&
                        (t.source
                            ? n.datepicker(t.method, $(t.source).val())
                            : (a = n.datepicker(t.method, a[0], a[1], a[2])) &&
                              t.target &&
                              $(t.target).val(a));
            });
    });
